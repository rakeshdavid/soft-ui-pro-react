...
const Home = () => {
  return (
    <div className={styles['container']}>
      ...
      <img
        alt="image"
        src="/playground_assets/curved6-1000w.jpg"
          ...
          <div className={styles['container13']}>
            <div className={styles['container14']}>
              ...
              <div className={styles['container15']}>
                <img
                  alt="image"
                  src="/playground_assets/team-4-1000h.jpg"
                  className={styles['image08']}
                />
                <div className={styles['container16']}></div>
                <img
                  alt="image"
                  src="/playground_assets/team-3-1000h.jpg"
                  className={styles['image09']}
                />
                <div className={styles['container17']}></div>
                <img
                  alt="image"
                  src="/playground_assets/team-2-1000h.jpg"
