  ...
  return (
    <div className={styles['container']}>
      ...
      <div className={styles['profile']}>
        <img
          alt="image"
          src="/playground_assets/bruce-mars-1000h.jpg"
          ...
          <div className={styles['form']}>
            ...
            <form className={styles['form1']}>
              ...
              <input
                ...
                className={` ${styles['textinput']} ${projectStyles['small']} ${projectStyles['thqTextInput']} `}
              />
              <label
              ...
              <input
                ...
                className={` ${styles['textinput1']} ${projectStyles['small']} ${projectStyles['thqTextInput']} `}
              />
              <label
              ...
              <textarea
                ...
                className={` ${styles['textarea']} ${projectStyles['small']} ${projectStyles['thqTextArea']} `}
              ></textarea>
            </form>
              ...
              <div className={styles['container13']}>
                <div className={styles['container14']}>
                  ...
                  <a
                    ...
                    className={` ${styles['link']} ${projectStyles['small']} ${projectStyles['thqLink']} `}
                  >
                    (+40) 772 100 200
                  </a>
                </div>
                <div className={styles['container15']}>
                  ...
                  <a
                    ...
                    className={` ${styles['link1']} ${projectStyles['small']} ${projectStyles['thqLink']} `}
                  >
